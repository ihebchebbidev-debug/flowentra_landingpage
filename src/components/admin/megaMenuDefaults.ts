  ...
  return {
    tabs: [
      ...
      },
      {
        ...
        icon: "Plug",
        items: [
          { label: "Gmail", desc: fr ? "Synchronisez vos emails Gmail." : "Sync your Gmail emails.", icon: "Mail", href: "/#integrations" },
          { label: "Outlook", desc: fr ? "Connectez votre messagerie Outlook." : "Connect your Outlook mailbox.", icon: "Inbox", href: "/#integrations" },
          { label: "Telegram", desc: fr ? "Notifications et alertes via Telegram." : "Notifications and alerts via Telegram.", icon: "Send", href: "/#integrations" },
          { label: "Stripe", desc: fr ? "Paiements en ligne sécurisés." : "Secure online payments.", icon: "CreditCard", href: "/#integrations" },
          { label: "Konnekt", desc: fr ? "Téléphonie et communications unifiées." : "Telephony and unified communications.", icon: "Phone", href: "/#integrations" },
          { label: "OpenRouter", desc: fr ? "IA et modèles de langage avancés." : "AI and advanced language models.", icon: "Brain", href: "/#integrations" },
        ],
      },
    ],
  };
